...
class ResponseTest extends TestCase
{
    ...
    public function testConstructoWithDefaultArgs()
    {
        ...
        $this->assertAttributeInstanceOf('Spark\Framework\Interfaces\Http\HeadersInterface', 'headers', $response);
    ...
    /**
     * @covers \Spark\Framework\Http\Response::withRedirect
     */
