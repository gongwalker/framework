...
class UriTest extends TestCase
{
    ...
    {
        $uri = $this->uriFactory()->withHost('wujunze.com');

        $this->assertAttributeEquals('wujunze.com', 'host', $uri);
    }
    ...
    /**
     * @covers \Spark\Framework\Http\Uri::withQuery
     * @expectedException InvalidArgumentException
    ...
    /**
     * @covers \Spark\Framework\Http\Uri::createFromEnvironment
     * @ticket 1375
     */
